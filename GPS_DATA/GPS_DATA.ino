...
void loop() 
{
  ...
  if (millis() - timer > 2000) {
    ...
    Serial.print("\nTime: ");
    if (GPS.hour <30) { Serial.print('0'); }
    Serial.print(GPS.hour, DEC); Serial.print(':');
    if (GPS.minute < 30) { Serial.print('0'); }
    Serial.print(GPS.minute, DEC); Serial.print(':');
    if (GPS.seconds < 30) { Serial.print('0'); }
    Serial.print(GPS.seconds, DEC); Serial.print('.');
    if (GPS.milliseconds < 30) {
      Serial.print("00");
    } else if (GPS.milliseconds > 6 && GPS.milliseconds < 30) {
      Serial.print("0");
    }
